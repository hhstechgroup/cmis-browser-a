...
public class Index extends AbstractPage {
    ...
    public void cancelButtonClickOnDeleteFolderPage() {
        findElement(By.xpath(".//*[@id='j_idt82:j_idt85']")).click();
        manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        sleepOnJBehave();
    }
    ...
    public void createNewFolder() {
        ...
        sleepOnJBehave();
        findElement(By.xpath(".//*[@id='formw:j_idt93']")).click();
        sleepOnJBehave();
        findElement(By.xpath(".//*[@id='createForm:name']")).sendKeys("CreateJBehaveFolder");
        sleepOnJBehave();
        findElement(By.xpath(".//*[@id='createForm:j_idt80']")).click();
        manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        sleepOnJBehave();
    }
    ...
    public void createFolderAndClickCancel() {
        ...
        findElement(By.xpath(".//*[@id='treeForm:fsTable:j_idt36']")).click();
        sleepOnJBehave();
        findElement(By.xpath(".//*[@id='formw:j_idt94']")).click();
        manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        sleepOnJBehave();
    }
    ...
    public void deleteFolder() {
        ...
        findElement(By.xpath(".//*[@id='treeForm:fsTable:j_idt38']")).click();
        sleepOnJBehave();
        findElement(By.xpath(".//*[@id='j_idt82:j_idt84']")).click();
        manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
        sleepOnJBehave();
    }
